...
class Settings(BaseSettings):
    ...
    # NOTE: LangGraph orchestration-hardening config (GRAPH_NODE_RETRY_*, GRAPH_TRACE_*,
    # GRAPH_CHECKPOINT_*) lives in src/config/graph_settings.py::GraphHardeningSettings so it
    # validates independently of this class's API-key requirement.
