...
class GraphBuilderHost(Protocol):
    ...
    def _neural_route_decision(self, state: Any) -> str: ...
    def _rule_based_route_decision(self, state: Any) -> str: ...
    def _neural_fallback_for_symbolic(self, query: str, state: Any) -> str: ...
