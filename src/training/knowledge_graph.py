    ...
    def _generate_answer(
        ...
        if question_type == "relationship":
            if graph_info.get("path_found"):
                ...
                e1 = entities[0] if len(entities) > 0 else "unknown"
                e2 = entities[1] if len(entities) > 1 else "unknown"
                return f"No direct relationship found between {e1} and {e2} in the knowledge graph."
