...
- `docs/`: Framework documentation (`GAME_DOMAINS.md`).
...
- `AlphaZeroLoss.forward()` gracefully handles `-inf` logits for zero-target actions (masked illegal actions) without producing NaN gradients or outputs.
